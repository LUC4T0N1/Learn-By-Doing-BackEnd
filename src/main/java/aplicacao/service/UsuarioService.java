...
public class UsuarioService {
    ...
    @Inject
    QuestaoRespondidaRepository questaoRespondidaRepository;
    ...
    @Inject
    GerarTokenService gerarTokenService;
    ...
    public void cadastrarUsuario( UsuarioDto dto) {
        try {
            ...
            if(existente==null){
                ...
                System.out.println("[Cadastrar Novo Usuario] Usuario de email " + dto.email + " cadastrado com sucesso!");
            }
           else{
    ...
    public UsuarioDto buscarUsuario(String email, String usuario) {
        try {
            ...
            if(usuarioObj != null){
                ...
                dto.questoesResolvidas = questaoRespondidaRepository.buscarQuestoesRespondidasPorUsuario(usuario);
    ...
    public AutenticacaoDto logarUsuario(UsuarioDto dto) {
        try {
            ...
            if(usuario == null){
                ...
                System.out.println("[Logar Usuario] Usuario logado com sucesso!");
                return AutenticacaoDto.instanciar(gerarTokenService.gerarToken(usuario.getUsuario(), usuario.getEmail()), usuario.getUsuario());
            }
